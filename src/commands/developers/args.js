...
module.exports = async (client, interaction, args) => {
    ...
    if (message == "information") {
        client.simpleEmbed({
            image: `https://res.cloudinary.com/lrmn/image/upload/v1685492098/catmakeup_f3bfgj.gif`
            ...
            client.embed({
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        value: `- Meet new people! \n- Play many fun games! \n- Discover the seasons! \n- Participate in events! \nAnd…. Last but not least, choose your own roles at <#1088032923443277824>!`,
                    },
                    {
                        name: `🎫┆How do I get help when needed?`,
                        value: `You can make a ticket in <#1088032923443277824>! We are happy to help you with your questions here and offer support in your server!`,
                    },
                    {
