    ...
    client.on(Discord.Events.InteractionCreate, async (interaction) => {
        ...
        if (interaction.customId == "Bot-helppanel") {
            if (interaction.values == "commands-Bothelp") {
                ...
                client.embed({
                    title: `❓・Help panel`,
                    desc: `View all command categories in the bot here! \n\n[Instagram](https://instagram.com/romanroman.nya) | [Invite](${client.config.discord.botInvite}) | [📧](https://discord.com/api/oauth2/authorize?client_id=1091257209469546566&permissions=8&scope=bot%20applications.commands)`,
                    ...
                    collector.on('collect', async i => {
                        if (i.customId == "helpNext") {
                            ...
                            if (page == 2) {
                                client.embed({
                                    title: `❓・Help panel`,
                                    desc: `View all command categories in the bot here! \n\n[Instagram](https://instagram.com/romanroman.nya) | [Invite](${client.config.discord.botInvite}) | [📧](https://discord.gg/Mzjmq2HJUg)`,
                                    fields: fields.slice(0, 24),
                                    components: [row2, row],
                                    type: 'update'
                                }, i)
