...
app.get('/', (req, res) => {
  res.send('This bot is running L RMN\'s  <a href="https://you-bot.is-a.fun">You`s BOT</a>')
})
...
axios.get('https://api.github.com/repos/lrmn7/yuibot/releases/latest').then(res => {
...
console.log(`\u001b[0m`)
console.log(chalk.red(`© L RMN | 2021 - ${new Date().getFullYear()}`))
